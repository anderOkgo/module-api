...
**Status: IN PROGRESS** (reorg/docs done 2026-07-15; the username-casing regression added directly to `scripts/smoke-test.js` 2026-07-15; broader "exhaustive" coverage remains explicit future work)
...
### Still TODO (future work, not started)
...
3. See the **Acceptance Criteria Catalog** (`docs/ACCEPTANCE_CRITERIA.md`) — the concrete, ongoing mechanism for item 1.
