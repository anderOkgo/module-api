...
import { getProduction, getProductionYear } from '../../../../src/modules/series/domain/services/index';

jest.mock('../../../../src/modules/series/domain/services/index'); // Mock the services
